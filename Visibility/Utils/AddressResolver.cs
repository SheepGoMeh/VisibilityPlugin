...
namespace Visibility.Utils
{
	internal class AddressResolver : BaseAddressResolver
	{
		...
		{
			this.CharacterEnableDrawAddress = sig.ScanText("E8 ?? ?? ?? ?? 48 8B 8B ?? ?? ?? ?? 48 85 C9 74 30 33 D2");
			this.CharacterDisableDrawAddress = sig.ScanText("48 89 5C 24 ?? 41 56 48 83 EC 20 48 8B D9 48 8B 0D ?? ?? ?? ??");
			this.CompanionEnableDrawAddress = sig.ScanText("40 53 48 83 EC 20 80 B9 ?? ?? ?? ?? ?? 48 8B D9 72 0C F7 81 ?? ?? ?? ?? ?? ?? ?? ?? 74 41");
